...
class BookingView extends GetView<BookingController> {
  ...
  Widget _buildDateSection(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Tanggal Acara', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w700)),
  ...
  Widget _buildPackageSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Paket Layanan', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w700)),
        const SizedBox(height: 10),
        Container(
          padding: const EdgeInsets.all(16),
          decoration: BoxDecoration(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              ...controller.package.features.map((f) => Padding(
                    padding: const EdgeInsets.only(bottom: 6),
                    child: Row(children: [
                      const Icon(Icons.check_circle_rounded, color: AppColors.success, size: 16),
                      const SizedBox(width: 8),
                      Text(f, style: GoogleFonts.poppins(fontSize: 13, color: AppColors.textSecondary)),
                    ]),
                  )),
            ],
          ),
  ...
  Widget _buildNotesSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Catatan (opsional)', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w700)),
        const SizedBox(height: 10),
        TextField(
  ...
  Widget _buildPriceSummary() {
    return Container(
      ...
      child: Column(
        children: [
          _PriceRow(label: 'Harga Paket', value: formatRupiah(controller.package.price)),
